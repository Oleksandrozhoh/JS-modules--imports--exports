...
})({"aKlaJ":[function(require,module,exports) {
...
const logBigExpences = function(state, limit) {
    // let output = '';
    const bigExpenses = state.filter((entry)=>entry.value <= -limit).map((element)=>element.description.slice(-2)).join(" / ");
    // .reduce(
...
},{}]},["aKlaJ","9dcWr"], "9dcWr", "parcelRequire7e89")
